                    ...
                    <form action="<?php echo ROOT ?>/Customer/Ordervehicle2/add " method="POST">
                               ...
                               <h1> Order Fuel </h1>
			                    ...
			                    <input type="hidden" name="id" value="<?php echo $data['id']; ?>" class="box1" readonly > <br>
								 <input type="text" name="vno" value="<?php echo $data['vno1']; ?>" class="box" readonly>
                             
			<br>
                                 <input type="text" name="vtype" value="<?php echo $data['vtype1']; ?>" class="box" readonly>
                            <br>
						
                                <?php 
  if($data['ftype1']=="92-Octane"){?>
   
                                <select name="ftype" class="box" required>
                                    <option value="<?php echo $data['ftype1']; ?>"><?php echo $data['ftype1']; ?></option>
