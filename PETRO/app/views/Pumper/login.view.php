...
<html lang="en">
    ...
    <body>
            ...
            <div class="main1">
            <form action="<?php echo ROOT ?>/Pumper/Login/login" method="post">
                ...
                <div class="column">
                    <div class="col">
                    <h3>Didn't have an account?<br><a href="<?php echo ROOT ?>/Pumper/Signup">Register Now.</h3></a>
                    </div>
                    <div class="col2">
                        <h3>Forgot the password? <br><a href="<?php echo ROOT ?>/Pumper/Forget_password"> Click here.</h3></a>
                    </div>
                </div><br><br>
            </form>
        </div>
