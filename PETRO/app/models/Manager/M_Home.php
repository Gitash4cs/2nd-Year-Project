<?php
    class M_Home extends Model{
        ...
        public function view($data){
            ...
            $sql_1 = "SELECT  *FROM $this->table3 where fuel_type = 'auto diesel' AND DATE(date_field) = CURDATE()";
            ...
            $sql_2 = "SELECT  *FROM $this->table3 where fuel_type = 'super diesel' AND DATE(date_field) = CURDATE()";
            ...
            $sql_3 = "SELECT *FROM $this->table3 where fuel_type = 'octane 92' AND DATE(date_field) = CURDATE()";
            ...
            $sql_4 = "SELECT *FROM $this->table3 where fuel_type = 'octane 95' AND DATE(date_field) = CURDATE()";
