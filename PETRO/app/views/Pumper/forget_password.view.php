...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ROOT ?>/CSS/Pumper/forgot.css" text="text/css">
...
<body>
    <div class="main-1">
        ...
        <form action="<?php echo ROOT ?>/Pumper/Forget_password/details" method="post">
            ...
            <div class="back">
                <button type="submit"><a href="<?php echo ROOT ?>/Pumper/Login" class="same">Back</a></button>
            </div>
        </form>
