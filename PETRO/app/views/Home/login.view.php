...
<form action="<?php echo ROOT ?>/Home/Login/login" method="post">
      <h2>Log In</h2>
      ...
      <input type="submit" name="submit" value="Log In" class="btn"><br><br>
	   <a href="<?php echo ROOT ?>/Pumper/Forget_password" class="fp">Forgot Password?</a>
      <p>don't have an account? <a href="<?php echo ROOT ?>/Customer/Register" class="register">Register Now</a></p>
   </form>
