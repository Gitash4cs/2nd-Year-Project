...
<div class="navbar">
  ...
  <a href="#">Contact Us</a>
  <a href="#">About Us</a>
      <a href="profile.php" class="right"><img src="images/pro.png" width="40px" height="40px"></a> 

</div>

<div class="row">
  <div class="side">
   <a class="active" href="profile.php"> <i class="fa fa-user icon"></i> View Profile</a>
  <a href="mv.html"> <i class="fa fa-car"></i> Place an Order</a>
   <a href="pumphistory.php"><i class="fa fa-user icon"></i> View Pumped History</a>
  <a href="complaint.php" class=""><i class="fa fa-user icon"></i> Add a Complaint</a>
    <a href="rating.php" class=""><i class="fa fa-user icon"></i> Add a Feedback</a>
                        ...
                        <form action="<?php echo ROOT ?>/Customer/Ordervehicle1/add " method="POST">
                               ...
                               <h1> Order Fuel </h1>
			                    ...
			                    <input type="hidden" name="id" value="<?php echo $data['id']; ?>" class="box1" readonly > <br>
								 <input type="text" name="vno" value="<?php echo $data['Oid']; ?>" class="box" readonly>
                             
			<br>
                                 <input type="text" name="vtype" value="<?php echo $data['vtype']; ?>" class="box" readonly>
                            <br>
						
                                <?php 
  if($data['ftype']=="92-Octane"){?>
  ...
  if($data['ftype']=="Diesel"){?>
                               ...
                               ?>
								   ...
								   <input type="number" name="amount" placeholder="Fuel amount" class="box" min="1"  max="<?php echo "$max" ?>"required>
