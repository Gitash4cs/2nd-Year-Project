...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ROOT ?>/CSS/fuel.css" text="text/css">

</head>

<body>
    <div class="container">
        <h2 class="h2">Octane 92</h2>
        <h3 class="h3">
        <?php if(!empty($error)){
                        echo($error);
                    }
        ...
        <div>
            <form action="<?php echo ROOT?>/Manager/Octane_92/add92" method="POST">
                <div>
