...
<br><br>
    <div class="main1">
        ...
        <label class="header">Customer Manager</label>
        <div class="row">
                <input type="text" class="box" name="customer_manager_id" placeholder="Manager ID" required><br><br>
                ...
                <input type="text" class="box"  name="customer_manager_NIC" placeholder="NIC" minlength="10" required><br><br>
                <input type="email" class="box" name="customer_manager_email" placeholder="Email" required><br><br>
